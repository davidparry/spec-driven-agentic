Feature: The client plans and sweeps all 23 MCP tools
  The Java client is an independent conformance harness against bdd mcp serve.
  ...
  @CLI-009
  Scenario: The plan names exactly 23 tools
    Then the tool plan names exactly 23 tools
